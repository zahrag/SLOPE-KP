...
**Figure**:The first row displays the original images of nine different bird species from the CUB dataset. <br />
...
**Figure**: The first row displays original images of six different bird species from the CUB dataset. <br />
...
**Figure**:The first row displays original RGB images of six different bird species from the CUB dataset. <br />
...
**Figure**: The first row displays original images of ten different bird species from the CUB dataset. <br />
...
**Figure**: The first row displays original images of 10 birds from the YouTubeVos and Davis video sequences.
